  ...
  return (
    <div className="fixed inset-0 bg-[#ffedd9] z-[60] flex flex-col transition-all duration-300 ease-in-out lg:hidden overflow-y-auto">
      ...
      <div className="flex items-center justify-between px-6 py-6 border-b border-black/10">
        ...
        <button onClick={onClose} className="p-2 bg-red-600 rounded-full text-white border border-black hover:bg-red-700 transition-colors">
          <X size={24} />
        </button>
      </div>
      ...
      <div className="px-6 pb-20 flex flex-col gap-2">
        <h3 className="text-sm font-bold text-black/50 font-poppins uppercase tracking-widest mb-4">Categories</h3>
        {loading ? (
