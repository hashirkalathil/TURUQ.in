  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Translator (Optional)</label>
          <input
            name="translator"
            value={values.translator || ""}
            onChange={handleChange}
            placeholder="Name of the translator"
            className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-red-500 focus:border-red-500 bg-background"
          />
        </div>
        <div>
