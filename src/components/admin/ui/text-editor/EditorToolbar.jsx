...
import {
  ...
  RemoveFormatting, ExternalLink, Heading, Palette, Highlighter, Code, BookOpen,
} from "lucide-react";
  ...
  return (
    <div ref={toolbarRef} className="p-3 shadow-md bg-background border-b border-slate-200 sticky top-0 z-10">
      <div className="flex flex-wrap items-center gap-1 max-w-7xl mx-auto">
        ...
        <ToolbarButton onClick={onShowFootnote} icon={BookOpen} title="Footnote / Reference" activeCommands={activeCommands} />
