    ...
    <form onSubmit={handleSubmit} className="p-4 space-y-4">
      ...
      <div>
        ...
        <div className="flex items-start space-x-4">
          {/* Image Preview */}
          <div className="w-24 h-32 bg-gray-100 border border-gray-300 rounded-md flex items-center justify-center overflow-hidden relative shrink-0">
