    ...
    <footer className="bg-background mt-[80px] lg:mt-[120px]">
      <div className="border-t border-b border-black/10">
        <div className="mx-auto flex flex-col md:flex-row items-center justify-between w-full max-w-[1250px] px-6 lg:px-[8.5%] py-10 md:py-8 gap-8 md:gap-0">
          <div className="footer-logo">
            <h2 className="font-oswald text-[32px] md:text-[45px] font-medium text-red-600 m-0 tracking-tight">TURUQ</h2>
          </div>
          
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 md:gap-[60px] lg:gap-[75px]">
            <a href="#" className="flex items-center gap-2 font-poppins text-[14px] md:text-[15px] font-medium text-black/60 hover:text-red-600 transition-all duration-300 group">
      ...
      <div className="mx-auto w-full max-w-[1250px] px-6 lg:px-[8.5%] py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left w-full">
          <span className="font-poppins text-[14px] font-normal text-black/50">
            © {new Date().getFullYear()} TURUQ. All rights reserved.
          </span>

          <span className="font-poppins text-[13px] font-normal text-black/40">
            Crafted with passion by{" "}
            <Link
              href="https://eucodes.in"
              className="inline-flex items-center gap-1.5 text-red-600 font-semibold hover:underline underline-offset-4 transition-all"
            >
              EUCODES
