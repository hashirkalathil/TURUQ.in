...
export default function UnsubscribePage() {
  ...
  const [status, setStatus] = useState(email ? "loading" : "error"); // loading, success, error
  ...
  return (
    <main className="min-h-[70vh] flex items-center justify-center px-4 py-20 bg-background">
      <div className="max-w-md w-full text-center space-y-8 p-10 lg:p-16 rounded-[40px] border border-black bg-background shadow-2xl">
        {status === "loading" && (
